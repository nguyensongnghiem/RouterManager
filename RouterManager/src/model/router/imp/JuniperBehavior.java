...
import model.router.IRouterBehavior;

public class JuniperBehavior implements IRouterBehavior {
    ...
    public ArrayList<String> getRunArea(String ip) {
       String username = "nghiem";
        ...
        try {
            ...
            String command2 = "show configuration protocols ospf | match area\n";
